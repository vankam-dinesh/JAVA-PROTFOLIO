...
const responses = [
  {
    ...
    response:
      "Dinesh Asghar is a passionate Full Stack Web Developer and Computer Science Engineering student, dedicated to building beautiful, responsive, and user-friendly websites. 💻🚀",
  },
  {
    keywords: [
      "your name",
    ...
    response: "I'm a chatbot created by Dinesh Asghar. 😊",
  },
  {
    keywords: ["developer name", "who made you", "who is your developer"],
    response: "My developer is Dinesh. 🚀",
  },
  {
    keywords: [
      "phone number",
    ...
    response: "You can contact Dinesh 📞 7981781303.",
  },
  {
    keywords: ["email", "mail", "gmail", "email address"],
    response: "You can reach him at 📧 dineshvankam56@gmail.com.",
  },
  {
    keywords: ["address", "location", "where do you live", "where is dinesh"],
  ...
  },
  {
    ...
    response:
      "He is skilled in 🔥 Full-Stack Web Development, Node.js, Php, MySQL MongoDB, JavaScript, HTML, CSS, and more!",
  },
  {
    keywords: [
      "projects",
      ...
      "portfolio",
      "project",
      "what has dinesh built",
    ],
    response:
      "His  projects include 🎯 Fiance app, Netfix clone,Meditation app,Random password generator, and a Weather App using React,etc. 🚀",
  },
  {
    keywords: [
      "wanderlust",
  ...
  },
  {
    ...
    response:
      "Check out his portfolio here: 🌐 https://portfolio-dinesh.netlify.app/.",
  },
  {
    keywords: [
      "college",
  ...
  {
    keywords: ["hobbies", "interests", "passion", "what does dinesh like"],
    response:
  ...
  },
  {
    ...
    response:
      "Yes! He is available for freelance projects. Contact him at 📧 dineshvankam56@gmail.com.",
  },
  {
  ...
  },
  {
    ...
    response:
      "You're welcome! Let me know if you need anything else about Dinesh. 😊",
  },
];
          ...
          messages: [
            {
              role: "system",
              content:
                "You are an assistant that answers questions specifically about Dinesh, a Full Stack Developer. Keep responses brief (1-2 sentences max) and relevant to Dinesh's skills, projects, education, or contact info. If the question isn't about Dinesh, politely decline to answer.",
            },
            {
              role: "user",
              content: userMessage,
...
function sendMessage() {
  ...
  typingIndicator.textContent = "DineshBot is typing...";
  ...
  setTimeout(async () => {
    try {
      ...
      if (!botResponse) {
        ...
        botResponse =
          apiResponse ||
          "I'm designed to answer questions about Dinesh. Could you ask something specific about his skills, projects, or contact information?";
      }
      ...
      addMessage(
        "I'm having some trouble right now. Please try asking something specific about Dinesh's skills or projects.",
        "bot-message"
      );
    }
  }, 1500);
